...
public class CardFormParser {

    // We don't use namespaces
    private static final String ns = null;

    private CardForm aadhaarCard;

    public CardForm parse(String xmlContent) throws XmlPullParserException, IOException {
        InputStream in = new ByteArrayInputStream(xmlContent.getBytes());
        aadhaarCard = new CardForm();
