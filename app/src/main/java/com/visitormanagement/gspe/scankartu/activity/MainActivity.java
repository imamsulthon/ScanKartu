...
import com.visitormanagement.gspe.scankartu.model.CardForm;
import com.visitormanagement.gspe.scankartu.model.CardFormParser;
        ...
        try {
            if (requestCode == 0) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    try {
                        CardForm newCard = new CardFormParser().parse(contents);
                        ...
                        alertDialog2.setTitle("Card Not Supported With full icon_info.");
